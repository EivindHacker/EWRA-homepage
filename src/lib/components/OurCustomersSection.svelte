...
<section class="flex min-h-screen flex-col items-center justify-center">
	<div
		...
		class="relative z-10 mx-auto mt-20 max-w-4xl translate-y-8 rounded-xl border border-white/10 bg-white/5 p-12 opacity-0 shadow-lg backdrop-blur-md transition-all duration-1000 ease-out"
